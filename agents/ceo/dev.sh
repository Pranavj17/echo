#!/bin/bash
#
# Development launcher for CEO MCP server
#
# This script starts the CEO agent in development mode with hot-reloading
...
echo "Starting CEO MCP server in development mode..."
