#!/bin/bash
#
# Development launcher for CTO MCP server
#
# This script starts the CTO agent in development mode with hot-reloading
...
echo "Starting CTO MCP server in development mode..."
